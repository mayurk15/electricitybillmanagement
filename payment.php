...
<form action="" method="post">
 Unit Price  &nbsp <input id="unit" type="number" min="0" max="50" value="0" step="0.1" onchange="computeUnit()"> &#8377; <br/> <br/>
 Total Unit  <input id="totalunit" type="number" min="0" max="100000" value="0" step="0.1" onchange="computeUnit()">&#8377; <br/> <br/>
 Late fee &#8377; <input id="latefee" type="number" value="0" step="1" onchange="computeUnit()">&#8377; </br> </br>
<h4> Total Cost &#8377;: </h4><h2 id="payment">  </h2>
