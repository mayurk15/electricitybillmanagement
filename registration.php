...
if(isset($_POST['register']))
{
    ...
    $run_query=mysqli_query($dbcon,$check_email_query, $check_meter_no_query);
...
exit();
    ...
    $insert_user="insert into users (user_name, user_email, user_pass, meter_no,) VALUE ('$user_name','$user_email',  '$user_pass', '$meter_no' )";
